...
Requirements, brainstorms, and implementation plans live under `specs/` — always, not `brainstorms/`, `docs/plans/`, or `docs/superpowers/` (these older locations are deprecated). Use this layout:
...
**Superpowers skills override:** The brainstorming and writing-plans skills default to writing under `docs/superpowers/`. In this repo, override that — all design docs, research outputs, and plans go under `specs/` using the layout above. Never create a `docs/superpowers/` directory.
